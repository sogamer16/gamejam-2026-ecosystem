    ...
    public class CardBase : MonoBehaviour,I2DTooltipTarget, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public virtual void OnPointerExit(PointerEventData eventData)
        {
            ...
            if (tooltipManager != null)
                HideTooltipInfo(tooltipManager);
        }
        ...
        protected virtual void ShowTooltipInfo()
        {
            ...
            var tooltipManager = TooltipManager.Instance;
            if (tooltipManager == null || tooltipManager.SpecialKeywordData == null || tooltipManager.SpecialKeywordData.SpecialKeywordBaseList == null)
                return;
